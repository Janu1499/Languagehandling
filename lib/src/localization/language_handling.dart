...
import 'language_handling_delegate.dart';
import 'language_handling_translator.dart';

typedef TranslatorCallback = void Function(Locale?);

class LanguageHandling {
  LanguageHandling._singleton() {
    _delegate = LanguageHandlingDelegate(null);
  }

  /// The instance object of [LanguageHandling] class.
  static final LanguageHandling instance = LanguageHandling._singleton();

  /// The package delegate. This is private, only use in the package.
  late LanguageHandlingDelegate _delegate;
  ...
  Future<void> init({
    ...
    LanguageHandlingTranslator.instance.mapLocales = mapLocales;
  ...
  Future<void> _handleLocale(
    ...
    _delegate = LanguageHandlingDelegate(_currentLocale);
  ...
  /// This just call the getName() function from [LanguageHandlingTranslator]
  /// class for getting the full language name by the language code.
  String getLanguageName({String? languageCode}) =>
      LanguageHandlingTranslator.instance
